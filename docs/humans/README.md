...
| `feature/sim-music/midi-notation-workflows` | `crate/sim-lib-midi-core` | 2 | Lift, lower, inspect, and export musical material across bounded lossless MIDI files, live MIDI fixtures, and notation forms. |

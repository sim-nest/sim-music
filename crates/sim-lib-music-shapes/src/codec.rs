...
use sim_lib_music_core::{
    Arranger, ArrangerPlacement, Articulation, AtomRef, Chord, Counterpoint, FilterRef, LaneTarget,
    Melody, MelodyItem, MidiFileObj, MidiTrackObj, Music, MusicError, MusicObject, Note, Par,
    PianoRoll, PitchRemap, PlacementTransform, PlayableRef, Progression, Rest, Score, Seq,
    StretchPolicy, Time, TimedNote, TracePolicy,
};
...
fn encode_arranger_placement(placement: &ArrangerPlacement) -> String {

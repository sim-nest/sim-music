...
pub const SYSTEM700_FIXTURE_REGENERATE_COMMAND: &str =
    "cargo run -p sim-lib-music-synth --bin system700-fixtures";
...
pub struct System700RenderFixtureMetadata {
    ...
    /// Hash of the rendered sample buffer.
...
pub fn system700_render_fixture_manifest() -> String {
    ...
    out.push_str("# Generated by `cargo run -p sim-lib-music-synth --bin system700-fixtures`.\n");
    out.push_str(&format!(
        "regenerate_command = \"{}\"\n",
...
fn fixture_metadata(
    ...
    let mut system = System700::new(patch.clone(), mode);

...
//! symmetry, Z-relation, and the [`IntervalVector`] census used by set theory.
//! [`PitchRangeMask`] does the same across the full 128-key MIDI range.
//! [`BitChord`] pairs a mask with an optional root, and [`ThirdStackSignature`]
//! encodes chords as stacks of minor and major thirds.
